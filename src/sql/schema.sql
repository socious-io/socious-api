...
-- Seed data ----
INSERT INTO public.job_categories (name, hourly_wage_dollars) VALUES
...
CREATE TYPE public.project_kind AS ENUM ('JOB', 'SERVICE');
CREATE TYPE public.service_length AS ENUM (
    'LESS_THAN_A_DAY',
    '1_3_DAYS',
    '1_WEEK',
    '2_WEEKS',
...
ALTER TABLE public.projects
    ADD COLUMN kind public.project_kind DEFAULT 'JOB' NOT NULL,
    ADD COLUMN service_length public.service_length DEFAULT NULL,
    ADD COLUMN service_total_hours integer,
    ADD COLUMN service_price integer;

CREATE TABLE public.service_work_samples (
  id UUID NOT NULL DEFAULT public.uuid_generate_v4() PRIMARY KEY,
  service_id UUID NOT NULL,
  document UUID NOT NULL,
  created_at TIMESTAMP DEFAULT NOW(),
  CONSTRAINT fk_service FOREIGN KEY (service_id) REFERENCES public.projects(id) ON DELETE CASCADE,
  CONSTRAINT fk_media FOREIGN KEY (document) REFERENCES public.media(id) ON DELETE CASCADE
);
